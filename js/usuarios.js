...
function getAllUsers(){
  ...
  .then((idToken) => {
    $.getJSON(
      'http://desolate-hollows-26219.herokuapp.com/admin/usuarios?idToken='+idToken,
      (data, status) => {
...
function agregar(event){
  ...
  .then((idToken) => {
    $.post(
      'http://desolate-hollows-26219.herokuapp.com/admin/usuario',
      {
        idToken: idToken,
        email: email,
        password: pass
...
function editarRol(uid,email,isAdmin){
  ...
  btnEditarRol.onclick = function(){
    ...
    .then((idToken) => {
      $.post(
        'http://desolate-hollows-26219.herokuapp.com/admin/setAdmin',
        {
          idToken: idToken,
          uid: uid,
          adminval: adminval
...
function eliminarUsuario(uid,email){
  ...
  btnEliminar.onclick = function(){
    ...
    .then((idToken) => {
      $.post(
        'http://desolate-hollows-26219.herokuapp.com/admin/usuario/remove',
        {
          idToken: idToken,
          uid: uid
        },
